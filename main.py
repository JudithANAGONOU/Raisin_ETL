...
raisin_data = pd.read_excel('raisin\Raisin_Dataset\Raisin_Dataset\Raisin_Dataset.xlsx')
...
try:
    ...
    for i,row in raisin_data.iterrows():
        sql = """INSERT INTO culture_raisin (area,major_axis_length,minor_axis_length, eccentricity,convex_area,extent,perimeter,class) VALUES (%s,%s,%s,%s,%s,%s,%s,%s)"""
        #print(sql)
